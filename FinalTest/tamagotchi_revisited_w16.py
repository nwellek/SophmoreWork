# This is code provided to examine before the final exam for SI 106 Winter 2016
...
class Parrot(Bird):
    sounds = ["chirp","feed me","that's all folks"]
...
pet_types = {'dog': Dog, 'lab': Lab, 'poodle': Poodle, 'cat': Cat, 'bird': Bird, 'parrot':Parrot}
...
def play():
    ...
    base_prompt = """
        Quit
        Adopt <petname_with_no_spaces> <pet_type - choose dog, cat, lab, poodle, bird, parrot, or another newly defined pet type>
        Greet <petname>
        Teach <petname> <word>
        Feed <petname>
