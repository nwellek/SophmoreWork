...
car_method_description = "car_rating will take into consideration the year, company, and safety rating and output all 3 of those numbers in a string."
...
flickrREST(extra_params= {'tags': ['sunset'],'per_page': 50, 'page': 1},cache_fname='flickr_response.txt')
...
f = open('flickr_data.txt','r')
new_str = f.read()
x = new_str[14:-1]
flickr_diction = json.loads(x)
