...
class ForwardPaddle(Pa):
    def deflect_ball(self, ball, side_hit):
        if self.player == 1 and side_hit == "LEFT":
            pass
        elif self.player == 2 and side_hit == "RIGHT"
            pass
        else:
            Paddle.deflect_ball(self, ball, side_hit)
    ...
    def __init__(self, 
        ...
        self.paddles = [
            ...
            ForwardPaddle(player = 1,
                    ...
                    name ='Player 1',
                    img_file = paddle_imgs[0],
                    initial_x= self.aux_paddle_buffer + paddle_width/2,
                    initial_y = self.height/2,
                    game=self
                    ),
            ForwardPaddle(player = 2,
                    up_key=pyglet.window.key.U,
                    down_key=pyglet.window.key.J,
                    left_key=pyglet.window.key.H,
                    right_key=pyglet.window.key.K,
                    name='Player 2',
                    img_file=paddle_imgs[1],
                    initial_x = self.width-self.aux_paddle_buffer - paddle_width/2,
                    initial_y = self.height/2,
                    game=self)      ]
        self.walls = [
